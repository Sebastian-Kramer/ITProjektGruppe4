...
public class KontaktlisteForm extends VerticalPanel {
	...
	/**
	 * Callback-Klasse f�r die L�schung der Kontaktliste
	 * @author Raphael
	 *
	 */
	...
	private class KontaktEntfernenCallback implements AsyncCallback<Void>{
		...
		@Override
		public void onSuccess(Void result) {
			// Bei erfolgreicher L�schung m�ssen sowohl die KontaktlisteForm als auch der NavigationTree neu geladen werden
			// und dem RootPanel hinzugef�gt werden
