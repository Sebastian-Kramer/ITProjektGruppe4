...
public class KontaktlisteKontaktTreeViewModel implements TreeViewModel {
	...
	/**
	 * Diese Nested Class soll den BusinessObjects im Baum eindeutige Schl�ssel zuweisen.
	 * Hierdurch k�nnnen Kontaktlisten-Objekte von Kontakt-Objekten unterschieden werden.
	 * der Schl�ssel f�r Kontaktliste-Objekte ist ein positiver, der von Kontakt-Objekten ein negativer.
	...
	/**
	 * Nested Class f�r das Setzen von Selektionsereignissen.
	 * Ist das ausgew�hlte Objekt in der Baumstruktur ein Objekt vom Typ Kontaktliste,
	 * wird die <code>KontaktlisteForm</code> ge�ffnet, die die Verwaltung und Bearbeitung der Kontaktliste erm�glicht.
	 * Ist das selektierte Objekt vom Typ Kontakt, wird die <code>KontaktForm</code> ge�ffnet, die die Verwaltung und Bearbeitung
	 * eines Kontakte erm�glicht.
	 * @author Raphael
	 *
	 */
	...
	/*
	 * Konstruktor f�r die Initialisierung der wichtigsten Variablen des Baums
	 */
