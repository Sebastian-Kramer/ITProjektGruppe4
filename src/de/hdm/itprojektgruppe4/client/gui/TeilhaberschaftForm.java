...
public class TeilhaberschaftForm extends VerticalPanel {
	...
	private List<Nutzer> kList = new ArrayList<>();
	...
	public void onLoad() {
		...
		cellAus.setSelectionModel(selectionModelAus, DefaultSelectionEventManager.<Eigenschaftauspraegung> createCheckboxManager());
		
		Column<Eigenschaftauspraegung, Boolean> checkBox = new Column<Eigenschaftauspraegung, Boolean>(new CheckboxCell(true, false)) {
		...
		Column<Eigenschaftauspraegung, String> ausp = new Column<Eigenschaftauspraegung, String>(new ClickableTextCell()){
