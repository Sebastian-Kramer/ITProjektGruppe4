...
/**
 * Mapper Klassen, die <code>Person</code>-Objekte auf einer relationalen
 * Datenbank abbildet.
 *
 */
...
public class PersonMapper {
	...
	/**
	 * Einf�gen eines neuen Objktes vom Typ Person in die DB der PK wird
	 * �berpr�ft und korrigiert -> maxID +1
	 * 
	 * @param p
	 *            die zu speichernde Person
	 * @return die bereits �bergebene Person
	 */
	...
	public int insertPerson(Person p) {
		...
		try {
			...
			if (rs.next()) {
				...
				stmt.executeUpdate(" INSERT INTO person (ID)" + " VALUES (" + p.getID() + ")");
